...
export function JobCard() {
  return (
    <div className="flex items-center mt-3 gap-3 bg-white/5 p-3 rounded-xl shadow-sm hover:bg-white/15 hover:shadow-lg hover:cursor-pointer">
      ...
      <div className="flex flex-col text-sm w-full">
        <div className="flex relative justify-between items-center">
          <span className="font-semibold text-neutral-300 hover:text-blue-400">
        ...
        <span className="text-gray-400">Ngân hàng TMCP Quân Đội</span>
